  ...
  return (
    <>
      ...
      location.pathname.includes("/register") ? null : (
        <div className="flex flex-row justify-between items-center w-full p-4 pt-2 dark:text-white text-black border-b border-b-green-400">
          <Link to={"/"}>
          ...
          <div className="flex flex-row space-x-4 items-center">
            <Link
              to="/"
              className={`${location.pathname === "/" ? "text-green-400" : ""}`}
            >
              Hjem
            </Link>
            <Link
